                            ...
                            <div className="widget widget_text clearfix">
                                ...
                                <div className="textwidget widget-text">
                                    ...
                                    <ul className="widget_contact_wrapper">
                                        <li><i className="ttm-textcolor-skincolor fa fa-phone"></i>(+880) 01773821395</li>
                                        <li><i className="ttm-textcolor-skincolor fa fa-envelope-o"></i><a href="mailto:info@example.com">akaeid786@gmail.com</a></li>
                                        <li><i className="ttm-textcolor-skincolor fa fa-map-marker"></i>Savar, Dhaka, Bangladesh</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
